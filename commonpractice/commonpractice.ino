...
//circular cylinder
float l1 = 10, h1 = 3, th1 = 90;
//triangle
float l2 = 15, h2 = 3, th2 = 70;
//rectangle
...
//color
float la[] = {21, 22, 24.5, 27.5, 29, 32, 34};
float sth = -3.5;
float dha[] = { 0, 1, 0.7, 1, 0.3, -0.5, 0};
float ha[7];
float tha1 = 0;
      ...
      switch (mode) {
        ...
        case 1:
          if (value == 7) break;
            ...
            tlocate(la[value], ha[value], tha1, PI / 2, 250);
            knock();
            waitForRotate();
          }
          //          switch (value) {
...
void preknock() {
  ...
  delay(3000);
  mySerial.println("{#004P0834T0250!#005P2000T0250!}");
  delay(250);
  tlocate(la[0], ha[0], tha1,
          PI / 2, 2000);
...
void knock() {
  ...
  delay(150);
  mySerial.println("#004P0834T0250!");
  delay(250);
}
